...
const I18N = {
  ...
  ui: {
    en: {
      ...
      footerEcosystemTitle: "Philosophy & Living Guides",
    ...
    zh: {
      ...
      heroSubtitle: "专为常住芬兰居民与新手量身打造的权威野生动物管理与狩猎安全实战指南。涵盖英语考取猎人证（Metsästäjätutkinto）、本土枪械执照合规申请、现代复合弓狩猎入门、900万公顷公有森林（Eräluvat）合法配额获取及道德猎获全流程。",
      heroBtnWizard: "生成我的起步路线 🎯",
      heroBtnQuiz: "开始模拟考试（精选15题） 📝",

      stat1Num: "300,000+",
      stat1Label: "芬兰持牌活跃猎人（占国民总人口 6%）",
      stat2Num: "9,000,000+",
      stat2Label: "公有森林狩猎面积（国家林业局 Eräluvat 开放配额）",
      stat3Num: "英语 / 芬兰语",
      stat3Label: "猎人考试官方支持英语、芬兰语及瑞典语试卷",
      stat4Num: "常住居民权益",
      stat4Label: "完全享有本土持枪许可、俱乐部申请与森林配额权益",
      ...
      speciesTag: "芬兰猎物图鉴",
      speciesTitle: "芬兰合法猎物物种与狩猎季速查",
      speciesSubtitle: "系统查询芬兰核心猎物物种、开放狩猎窗口期、法定适宜武器及野外狩猎技巧。",
      speciesSearchPlaceholder: "按芬兰语、中文、英语或拉丁学名搜索...",
      filterAll: "全部物种",
      filterBig: "大型鹿科",
      filterGrouse: "森林松鸡类",
      filterWaterfowl: "野鸭与水禽",
      filterSmall: "小型哺乳兽类",
      filterInvasive: "外来入侵捕食者",
      seasonLabel: "📅 开放狩猎季：",
      weaponsLabel: "🔫 合法武器：",
      permitLabel: "🎫 许可证需求：",
      fieldTipLabel: "🌲 实战技巧：",
      ...
      calcTag: "预算规划",
      calcTitle: "芬兰狩猎启动开销与装备测算器",
      calcSubtitle: "客观透明地测算在芬兰开启狩猎爱好的真实财务预算与装备配置方案。",
      calcGunTitle: "🔫 传统火器路线",
      calcGunDesc: "购置12号双管/半自动霰弹枪或.308猎用步枪（需警察局持枪许可）",
      calcBowTitle: "🏹 现代复合弓路线",
      calcBowDesc: "购置专业复合猎弓（免警察局牌照申请、免家庭专业枪柜强制要求）",
      calcGuidedTitle: "🤝 导师陪同/向导路线",
      calcGuidedDesc: "由资深持照猎人指导陪同，在购买自用武器前先积累林间实操经验",

      checklistsTag: "全套备战清单",
      checklistsTitle: "芬兰猎人三大核心实操备查清单",
      checklistsSubtitle: "涵盖从资格考试、靶场射击到首次进山实弹围猎的交互式任务清单。",
      clExamTitle: "📝 猎人考试当天准备",
      clRangeTitle: "🎯 靶场实弹练习日",
      ...
      footerEcosystemTitle: "活态哲学与随行指南",
      ...
      footerEcosystemTitle: "Eräfilosofia ja oppaat",
