...
All documentation can be viewed directly in the **Interactive Web App Reader** or as **Standalone Trilingual HTML Pages** (with live English, Chinese, and Finnish switching, plus dual-language comparison):

1. **[01. Legal Framework & Hunter's Examination](docs/01_legal_framework_and_exam.html)** ([Markdown](docs/01_legal_framework_and_exam.md))
...
2. **[02. Firearms, Licensing & Supervised Shooting](docs/02_firearms_and_licensing.html)** ([Markdown](docs/02_firearms_and_licensing.md))
...
3. **[03. Bow Hunting (*Jousimetsästys*) — The Modern Entry Route](docs/03_bow_hunting_alternative.html)** ([Markdown](docs/03_bow_hunting_alternative.md))
...
4. **[04. Where to Hunt: Land Access & Permits](docs/04_land_access_and_permits.html)** ([Markdown](docs/04_land_access_and_permits.md))
...
5. **[05. Game Species & Seasons](docs/05_game_species_and_seasons.html)** ([Markdown](docs/05_game_species_and_seasons.md))
   - Small game: Forest grouse (capercaillie, black grouse, hazel grouse), waterfowl (Aug 20 opening), hares.
   - Big game: Moose (*hirvi*), white-tailed deer (*valkohäntäpeura*), roe deer (*metsäkauris*).
   - The Big Game Shooting Test (*ampumakoe* / *hirvikoe*).
   - Invasive predator management: Raccoon dog (*supikoira*) and American mink (*minkki*).
6. **[06. Zero-Experience Practical Roadmap](docs/06_zero_experience_roadmap.html)** ([Markdown](docs/06_zero_experience_roadmap.md))
   - Step-by-step phased roadmap from Month 1 (unarmed beater / clay range visitor) to Year 1 (first ethical harvest).
   - Mentorship (*kummitoiminta*), hunting etiquette, and how to find local hunting companions.
7. **[07. Safety, Gear & Ethics](docs/07_safety_gear_and_ethics.html)** ([Markdown](docs/07_safety_gear_and_ethics.md))
   - Mandatory blaze orange laws (Metsästysasetus: 2/3 coverage requirement).
   - Lead-shot bans in wetlands (EU REACH).
